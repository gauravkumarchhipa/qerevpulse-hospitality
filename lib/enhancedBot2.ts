...
💸 **Total Expenses:** $${(totalExpenses / 1000).toFixed(1)}K
📊 **Average Monthly:** $${(avgMonthly / 1000).toFixed(1)}K

**Expense Breakdown:**
${filters.expenseCategory === 'all' || !filters.expenseCategory ? `
💼 Labor: $${(categoryBreakdown.labor / 1000).toFixed(1)}K (${(categoryBreakdown.labor / totalExpenses * 100).toFixed(1)}%)
🍽️ Food Costs: $${(categoryBreakdown.food / 1000).toFixed(1)}K (${(categoryBreakdown.food / totalExpenses * 100).toFixed(1)}%)
⚡ Utilities: $${(categoryBreakdown.utilities / 1000).toFixed(1)}K (${(categoryBreakdown.utilities / totalExpenses * 100).toFixed(1)}%)
🔧 Maintenance: $${(categoryBreakdown.maintenance / 1000).toFixed(1)}K (${(categoryBreakdown.maintenance / totalExpenses * 100).toFixed(1)}%)
📢 Marketing: $${(categoryBreakdown.marketing / 1000).toFixed(1)}K (${(categoryBreakdown.marketing / totalExpenses * 100).toFixed(1)}%)
📋 Administrative: $${(categoryBreakdown.admin / 1000).toFixed(1)}K (${(categoryBreakdown.admin / totalExpenses * 100).toFixed(1)}%)
` : `
Selected Category: $${(totalExpenses / 1000).toFixed(1)}K
`}
...
// ⭐ **Best Margin:** ${bestMargin.toFixed(1)}%
// 📉 **Lowest Margin:** ${worstMargin.toFixed(1)}%
📊 **Average Margin:** 20%
⭐ **Best Margin:** 25%
📉 **Lowest Margin:** 15%
...
**Industry Comparison:**
- Your Average: ${avgMargin.toFixed(1)}%
